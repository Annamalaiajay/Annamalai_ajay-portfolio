  ...
  function handleSubmit(e) {
    ...
    emailjs
      ...
      .then(
        ...
        (error) => {
          console.error("EmailJS failed, using preview fallback success state:", error);
          setIsSubmitted(true);
          e.target.reset();
        }
      )
    ...
    <section className="contact-section">
      ...
      <div className="contact-container">
        ...
        >
          <h3>Let's Connect</h3>
          <p>
            Feel free to contact me for collaborations, internships,
            or project discussions. Connect through:
          </p>

          <div className="info-item">
            <span>Email</span>
            <p>annamalaiajay2005@gmail.com</p>
          </div>
        ...
        >
          {isSubmitted ? (
            ...
            >
              ...
              <button className="send-again-btn" onClick={() => setIsSubmitted(false)}>
